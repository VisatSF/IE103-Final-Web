...
INSERT INTO menu_items (category_id, slug, stock, name, description, price, image_url, is_featured, display_order) VALUES
  (1, 'combo-mot-minh-an-ngon', 100, 'Combo Một Mình Ăn Ngon', '1 miếng gà giòn + 1 mì ý sốt bò bằm', 78000, '/combo-mot-minh-an-ngon.jpg', 1, 1),
  (1, 'combo-cap-doi-an-y-1', 100, 'Combo Cặp Đôi Ăn Ý 1', '2 miếng gà giòn + 2 mì ý sốt bò bằm', 145000, '/combo-cap-doi-an-y-1.jpg', 0, 2),
  (1, 'combo-cap-doi-an-y-2', 100, 'Combo Cặp Đôi Ăn Ý 2', '3 miếng gà giòn + 1 mì ý sốt bò bằm', 145000, '/combo-cap-doi-an-y-2.jpg', 0, 3),
  (1, 'combo-ca-nha-no-ne', 100, 'Combo Cả Nhà No Nê', '4 miếng gà giòn + 2 mì ý sốt bò bằm', 185000, '/combo-ca-nha-no-ne.jpg', 0, 4),
  (2, '1-mieng-ga-gion', 100, '1 miếng gà giòn', '1 miếng gà giòn rụm', 30000, '/1-mieng-ga-gion.webp', 1, 1),
  (2, '2-mieng-ga-gion', 100, '2 miếng gà giòn', '2 miếng gà giòn rụm', 60000, '/2-mieng-ga-gion.webp', 0, 2),
  (2, '4-mieng-ga-gion', 100, '4 miếng gà giòn', '4 miếng gà giòn rụm', 116000, '/4-mieng-ga-gion.webp', 0, 3),
  (2, '6-mieng-ga-gion', 100, '6 miếng gà giòn', '6 miếng gà giòn rụm', 174000, '/6-mieng-ga-gion.webp', 0, 4),
  (2, '2-ga-khoai-nuoc', 100, '2 gà + khoai + nước', '2 miếng gà giòn + khoai tây vừa + nước ngọt thường', 80000, '/2-ga-khoai-nuoc.webp', 0, 5),
  (2, 'com-ga-sup-nuoc', 100, 'Cơm gà + súp + nước', 'Cơm gà giòn + súp bí đỏ + nước ngọt', 50000, '/com-ga-sup-nuoc.webp', 0, 6),
  (2, '1-ga-khoai-nuoc', 100, '1 gà + khoai + nước', '1 miếng gà giòn + khoai tây vừa + nước ngọt thường', 50000, '/1-ga-khoai-nuoc.webp', 0, 7),
  (3, 'my-y-sot-bo-bam-vua', 100, 'Mỳ Ý sốt bò bằm (Vừa)', 'Mỳ Ý sốt bò bằm cỡ vừa', 30000, '/my-y-sot-bo-bam-vua.jpg', 1, 1),
  (3, 'my-y-sot-bo-bam-lon', 100, 'Mỳ Ý sốt bò bằm (Lớn)', 'Mỳ Ý sốt bò bằm cỡ lớn', 40000, '/my-y-sot-bo-bam-lon.jpg', 0, 2),
  (3, 'ga-my-y-nuoc', 100, 'Gà + Mỳ Ý + Nước', '1 miếng gà giòn vui vẻ + 1 mỳ ý sốt bò bằm + 1 nước ngọt', 65000, '/ga-my-y-nuoc.webp', 0, 3),
  (3, 'my-lon-2-ga-xl-khoai-nuoc', 100, 'Mỳ lớn + 2 Gà XL + Khoai + Nước', 'Mỳ ý sốt bò bằm lớn + 2 miếng gà giòn không xương + khoai tây vừa + nước ngọt', 75000, '/my-lon-2-ga-xl-khoai-nuoc.jpg', 0, 4),
  (3, 'my-lon-2-ga-xl-nuoc', 100, 'Mỳ lớn + 2 Gà XL + Nước', 'Mỳ ý sốt bò bằm lớn + 2 miếng gà không xương + nước ngọt', 65000, '/my-lon-2-ga-xl-nuoc.webp', 0, 5),
  (4, 'com-ga-sot-cay', 100, 'Cơm gà sốt cay', '1 miếng gà sốt cay + cơm', 45000, '/com-ga-sot-cay.jpg', 1, 1),
  (4, '2-mieng-ga-sot-cay', 100, '2 miếng gà sốt cay', '2 miếng gà sốt cay', 65000, '/2-mieng-ga-sot-cay.jpg', 0, 2),
  (4, '2-ga-cay-khoai-nuoc', 100, '2 Gà cay + Khoai + Nước', '2 miếng gà sốt cay + khoai tây + pepsi thường', 90000, '/2-ga-cay-khoai-nuoc.jpg', 0, 3),
  (4, 'com-ga-cay-nuoc', 100, 'Cơm gà cay + Nước', '1 miếng gà sốt cay + cơm + nước', 50000, '/com-ga-cay-nuoc.jpg', 0, 4),
  (4, 'com-ga-cay-sup-nuoc', 100, 'Cơm gà cay + Súp + Nước', '1 cơm gà sốt cay + pepsi thường + súp bí đỏ', 55000, '/com-ga-cay-sup-nuoc.jpg', 0, 5),
  (4, '1-ga-cay-khoai-nuoc', 100, '1 Gà cay + Khoai + Nước', '1 miếng gà sốt cay + khoai tây + pepsi thường', 55000, '/1-ga-cay-khoai-nuoc.jpg', 0, 6),
  (4, '1-mieng-ga-sot-cay', 100, '1 miếng gà sốt cay', '1 miếng gà sốt cay', 35000, '/1-mieng-ga-sot-cay.jpg', 0, 7),
  (5, 'burger-ga-gion-nuoc', 100, 'Burger gà giòn + nước', 'Burger gà giòn kèm nước ngọt', 35000, '/burger-ga-gion-nuoc.webp', 1, 1),
  (5, 'burger-bbq-khoai-nuoc', 100, 'Burger BBQ + Khoai + Nước', 'Burger BBQ kèm khoai và nước', 50000, '/burger-bbq-khoai-nuoc.webp', 0, 2),
  (5, 'burger-bbq-nuoc', 100, 'Burger BBQ + Nước', 'Burger BBQ kèm nước ngọt', 35000, '/burger-bbq-nuoc.webp', 0, 3),
  (5, 'burger-bbq', 100, 'Burger BBQ', 'Burger BBQ đậm vị', 30000, '/burger-bbq.webp', 0, 4),
  (5, 'burger-ga-gion', 100, 'Burger gà giòn', 'Burger gà giòn thơm ngon', 30000, '/burger-ga-gion.webp', 0, 5),
  (5, 'burger-ga-gion-khoai-nuoc', 100, 'Burger gà giòn + Khoai + Nước', 'Burger gà giòn kèm khoai và nước', 50000, '/burger-ga-gion-khoai-nuoc.webp', 0, 6),
  (6, 'khoai-tay-chien-lon', 100, 'Khoai tây chiên (Lớn)', 'Khoai tây chiên giòn rụm cỡ lớn', 25000, '/khoai-tay-chien-lon.jpg', 1, 1),
  (6, 'khoai-vien-rong-bien', 100, 'Khoai viên rong biển', 'Khoai viên rong biển giòn ngon', 25000, '/khoai-vien-rong-bien.jpg', 0, 2),
  (6, 'khoai-tay-chien-vua', 100, 'Khoai tây chiên (Vừa)', 'Khoai tây chiên giòn rụm cỡ vừa', 20000, '/khoai-tay-chien-vua.jpg', 0, 4),
  (7, 'banh-xoai-dao', 100, 'Bánh xoài đào', 'Bánh xoài đào ngọt mát', 15000, '/banh-xoai-dao.webp', 1, 1),
  (7, 'tropical-sundae', 100, 'Tropical Sundae', 'Sundae trái cây nhiệt đới', 20000, '/tropical-sundae.webp', 0, 2),
  (7, 'kem-sua-tuoi', 100, 'Kem sữa tươi', 'Kem sữa tươi mát lạnh', 5000, '/kem-sua-tuoi.webp', 0, 4),
  (7, 'kem-socola', 100, 'Kem socola', 'Kem socola béo ngậy', 7000, '/kem-socola.webp', 0, 5),
  (7, 'kem-vanilla', 100, 'Kem Vanilla', 'Kem vanilla thơm ngon', 15000, '/kem-vanilla.webp', 0, 6),
  (8, 'pepsi-vua', 100, 'Pepsi Vừa', 'Pepsi size vừa', 10000, '/pepsi-vua.webp', 1, 1),
  (8, '7up-vua', 100, '7Up Vừa', '7Up size vừa', 10000, '/7up-vua.webp', 0, 2),
  (8, 'mirinda-vua', 100, 'Mirinda Vừa', 'Mirinda size vừa', 10000, '/mirinda-vua.webp', 0, 3),
  (8, 'pepsi-lon', 100, 'Pepsi Lớn', 'Pepsi size lớn', 15000, '/pepsi-lon.webp', 0, 4),
  (8, '7up-lon', 100, '7Up Lớn', '7Up size lớn', 15000, '/7up-lon.webp', 0, 5)
ON DUPLICATE KEY UPDATE
...
INSERT INTO promotions (title, slug, description, promo_code, discount_type, discount_value, icon_key, valid_from, valid_until, terms, status) VALUES
  ...
  ('Mua 2 Tặng 1 Gà Rán', 'mua-2-tang-1-ga-ran', 'Mua 2 miếng gà rán tặng thêm 1 miếng cùng loại', 'CHICKEN2FOR1', 'fixed', 0, 'Gift', '2026-04-01', '2026-05-25', 'Không áp dụng đồng thời nhiều chương trình khuyến mãi.', 'active'),
